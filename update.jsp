								...
								<tbody>
									...
									<tr>
										<td class="input"><input type="text" id="useremail"
											name="useremail" title="이메일" class="formText formText_Email" /></td>
									</tr>
									<tr>
										<td colspan="3" class="blank02"></td>
									</tr>
					...
					<tbody>
						<tr>
							<%
								int id = session_id;
							%>
							<td class="input"><%=id%> <input type="hidden" id="userid"
								name="userid" title="아이디" value="<%=id%>"
								class="formText formText_ID" /></td>
						</tr>
						<tr>
							<td colspan="3" class="blank02"></td>
