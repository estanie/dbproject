        ...
        <div class="pointBox" style="margin-bottom: 100px">
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr height="25" align="center">
              ...
              <td align="center"><%=rs.getString("b_no")%>
              </td>
              <td align="center"><a href="view.jsp?idx=<%=rs.getString("b_no")%>"><%=rs.getString("b_title")%>
              </a></td>
              <td align="center"><%=rs.getString("b_name")%>
              </td>
              <td align="center"><%=rs.getString("b_hit")%>
              </td>
              <td>&nbsp;</td>
            </tr>
          ...
          <center>
            ...
            <div class="pointBox">
              <table class=table4_1>
                <tr align="center"><h1>검색결과 없음</h1></tr>
              </table>
              <%
                }
                pstmt.close();
